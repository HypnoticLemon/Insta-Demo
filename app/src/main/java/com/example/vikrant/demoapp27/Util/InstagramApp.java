package com.example.vikrant.demoapp27.Util;
...
public class InstagramApp {
    ...
    public static String mCallbackUrl = "https://wtfffp.blogspot.in/";
    ...
    public void fetchUserData(final Handler handler) {
        URL url = null;
        try {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, url.toString(), new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    Log.e(TAG, "On FetchUserData Response: " + response);

                    JSONObject jsonObj = null;
                    try {
                        jsonObj = (JSONObject) new JSONTokener(response)
                                .nextValue();
                        ...
                        Log.e(TAG, "TAG_USERNAME : " + data_obj.getString(TAG_USERNAME));
                        ...
                        userInfo.put(TAG_COUNTS,
                                data_obj.getString(TAG_COUNTS));
            ...
            AppController.getInstance().addToRequestQueue(stringRequest, "accessToken");
